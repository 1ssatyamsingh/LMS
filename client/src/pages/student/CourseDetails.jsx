  ...
  return courseData ? (
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative  isolate items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
                    ...
                    <ul className="list-disc md:pl-10 pl-4 pr-4 py-2 text-gray-600 border-t border-gray-300">
                      {chapter.chapterContent.map((lecture, i) => (
                        <li key={i} className="flex items-start gap-2 py-1">
                          ...
                          />
                          <div className="flex justify-between w-full items-center text-gray-800 text-xs md:text-default">
        ...
        {/*right column*/}
        <div className="max-w-[424px] shadow-[0px_4px_15px_2px_rgba(0,0,0,0.1)] rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
          {playerData ? (
            <YouTube
